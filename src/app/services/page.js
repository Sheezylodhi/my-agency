        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-white leading-[1.1]">
              Digital solutions built around <br className="hidden sm:inline" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <IconComponent className={`w-4 h-4 ${isActive ? "text-blue-400" : "text-slate-500 group-hover:text-slate-300"}`} />
                      <span className="text-sm font-medium">{srv.title}</span>
                    </div>
                    <ArrowRight className={`w-4 h-4 transition-transform ${isActive ? "text-blue-400 translate-x-1" : "text-slate-600"}`} />
                  </button>
                );
              })}
            </div>
            ...
            <div className="lg:col-span-7">
              <AnimatePresence mode="wait">
                ...
                >
                  <div className="absolute top-0 right-0 p-8 text-blue-500/10 font-mono text-7xl font-bold pointer-events-none">
                    {activeService.num}
                  </div>
