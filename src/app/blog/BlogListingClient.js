...
export default function BlogListingClient({
  ...
  const normalizedPosts = useMemo(() => {
    return posts.map((post) => ({
      ...post,
      categoryKey: post.category?.toUpperCase() || "",
    }));
  }, [posts]);
  ...
  const filteredPosts = useMemo(() => {
    ...
    const categoryKey = activeCategory.toUpperCase();

    return normalizedPosts.filter(
      (post) => post.categoryKey === categoryKey
    );
  }, [normalizedPosts, activeCategory]);
  ...
  // EDITOR'S PICKS
  // ==========================================
  const fallbackEditorsPicks = useMemo(() => {
    const editorsPicks = normalizedPosts
      .filter((post) => post.editorPick)
      .slice(0, 3);

    return editorsPicks.length > 0
      ? editorsPicks
  ...
  // ==========================================
  // CATEGORY COUNTS
  // Calculate once instead of filtering posts
  // inside every discipline item.
  // ==========================================
  const categoryCounts = useMemo(() => {
    const counts = {};

    for (const post of normalizedPosts) {
      const category = post.categoryKey;
  ...
  return (
    <main className="bg-[#FFFFFF] min-h-screen selection:bg-blue-600 selection:text-white text-[#0A0A0A] font-sans">
      ...
      <section className="relative pt-36 pb-28 md:pt-44 md:pb-36 bg-[#05070B] text-white overflow-hidden border-b border-white/10">
        ...
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[650px] h-[350px] bg-blue-600/10 blur-[130px] rounded-full pointer-events-none" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg sm:text-xl text-slate-300 font-light leading-relaxed max-w-2xl">
                Practical engineering guides, architectural blueprints, SaaS
                strategies, AI automation workflows, eCommerce systems, and
                digital growth perspectives written for founders, engineering
                leaders, and growing companies.
              </p>
              ...
              <div className="p-8 sm:p-10 rounded-2xl bg-white/[0.03] border border-white/10 backdrop-blur-sm relative overflow-hidden group">
                ...
                <div className="space-y-4 mb-8">
                  ...
                  <p className="text-sm text-slate-400 font-light leading-relaxed">
                    Explore structured documentation covering modern web
                    architecture, SaaS applications, AI workflows, eCommerce,
                    SEO, cloud infrastructure, and enterprise software.
                  </p>
      ...
      <div className="sticky top-0 z-30 bg-white/90 backdrop-blur-md border-b border-[#E5E2DC]">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <div className="max-w-3xl mb-16">
            ...
            <p className="text-base sm:text-lg text-[#525252] font-light leading-relaxed">
              Engineering guides, architectural breakdowns, and practical
              perspectives from our development practice.
            </p>
      ...
      <section className="py-28 bg-[#0A0D12] text-white text-center border-b border-white/10 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10 space-y-6">
          ...
          <h2 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-[1.1]">
            "Good technology is not about adding more. It's about making the
            right things work better."
          </h2>

          <p className="text-base sm:text-lg text-slate-400 font-light max-w-xl mx-auto leading-relaxed">
            Every project changes how we think about products, systems and the
            people who use them.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <div className="border-t border-[#E5E2DC]">
            ...
            {disciplines.map((item, idx) => {
              ...
              return (
                <button
                  key={item.category || item.num || idx}
                  type="button"
                  onClick={() => setActiveCategory(item.category)}
                  className="group w-full text-left py-8 px-6 sm:px-8 bg-transparent hover:bg-white border-b border-[#E5E2DC] transition-all duration-300 cursor-pointer flex flex-col md:flex-row md:items-center justify-between gap-6"
                >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-6 space-y-4">
                ...
                <p className="text-base text-[#525252] font-light leading-relaxed max-w-md">
                  Get occasional perspectives on digital products, engineering,
                  design and AI from WebMash Labs. Unsubscribe anytime.
                </p>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-blue-600 mt-0.5">
                        We'll send our next publication directly to your inbox.
                      </p>
      ...
      <section className="py-28 bg-[#05070B] text-white relative overflow-hidden text-center">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[550px] h-[250px] bg-blue-600/10 blur-[100px] rounded-full pointer-events-none" />

        <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">

          <span className="text-xs font-mono uppercase tracking-widest text-blue-400 block mb-4">
            LET'S CREATE VALUE
          </span>
          ...
          <p className="text-lg sm:text-xl text-slate-300 font-light leading-relaxed mb-10 max-w-2xl mx-auto">
            Reading is useful. Building is better. Let's turn your idea into
            something scalable and built to last.
          </p>
