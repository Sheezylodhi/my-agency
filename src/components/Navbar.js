  ...
  return (
    <>
      ...
      <nav
        ...
        className="fixed top-0 left-0 w-full z-[100] transition-all duration-500 bg-[#0B0F19]/85 backdrop-blur-[24px] border-b border-white/[0.08] shadow-[0_20px_40px_rgba(0,0,0,0.4)]"
      >
