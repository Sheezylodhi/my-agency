  ...
  const technologies = [
    {
      name: "Next.js",
      svg: (
        <svg className="h-8 w-8 text-white" viewBox="0 0 180 180" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      name: "React",
      svg: (
        <svg className="h-8 w-8 text-[#61DAFB]" viewBox="-11.5 -10.23174 23 20.46348" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      name: "TypeScript",
      svg: (
        <svg className="h-8 w-8" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      name: "Node.js",
      svg: (
        <svg className="h-8 w-8 text-[#5FA04E]" viewBox="0 0 256 296" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      name: "MongoDB",
      svg: (
        <svg className="h-8 w-8 text-[#47A248]" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      name: "Stripe",
      svg: (
        <svg className="h-8 w-8 text-[#635BFF]" viewBox="0 0 60 25" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      name: "Cloudflare",
      svg: (
        <svg className="h-8 w-8 text-[#F38020]" viewBox="0 0 32 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      name: "Docker",
      svg: (
        <svg className="h-8 w-8 text-[#2496ED]" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      name: "AWS",
      svg: (
        <svg className="h-8 w-8 text-[#FF9900]" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <section className="relative isolate overflow-hidden bg-[linear-gradient(to_bottom,#0B0F19_0%,#0E1320_50%,#101726_100%)] text-white py-28 border-t border-white/15">
      ...
      <div className="relative mx-auto max-w-[1400px] px-6 lg:px-12 text-center">
        ...
        <div className="mt-20 relative w-full overflow-hidden [mask-image:linear-gradient(to_right,transparent,white_15%,white_85%,transparent)]">
